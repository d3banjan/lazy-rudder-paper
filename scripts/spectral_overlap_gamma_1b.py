"""γ₁ — spectral overlap of ΔW top-k singular vectors onto base W top-k at Pythia-1B.
...
RUNS = [
    ...
    ("v3_clm_r128_1b", RESULTS / "v3" / "checkpoints" / "checkpoint-800", 128, 256),
]
...
RUN_MAP_410M = {
    "v2_dpo_r128_1b": "v2_dpo_r128",
    "v3_clm_r128_1b": "v3_clm_r128",
}
