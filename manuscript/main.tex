...
the DPO-minus-CLM orthogonal fraction gap is uniformly below $0.6$
percentage points (+0.27 pp at $k{=}5$, +0.35 pp at $k{=}10$, +0.56 pp
at $k{=}20$, +0.18 pp at $k{=}srank$), far below the 5 pp threshold
for rejecting the null. Both adapters place $\approx 99\%$ of
Frobenius mass outside the top-$k$ base subspace --- because low-rank
$\Delta W$ (srank $\approx 3$) by construction fills only a tiny
fraction of the 2048-dimensional input space, and the top-5 base
subspace spans only $5/2048 \approx 0.24\%$ of that space. The
