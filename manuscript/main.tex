...
(iv) The $\gamma$ metric was originally reported only on
\texttt{attention.query\_key\_value}; preliminary cross-module
extensions (\texttt{attention.dense}, MLP up/down projections) are
reported in the supplementary results (see
\texttt{results/spectral\_overlap\_gamma\_modules/}) but full interpretive
integration into the main narrative is pending further analysis.
