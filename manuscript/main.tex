...
endpoint of $\bitfitLoRAReference$.\footnote{The LoRA-DPO reference
$\bitfitLoRAReference$ is stored in \texttt{bitfit\_dpo\_strike/summary.json};
no separate run-level results JSON is retained for this reference run.
Provenance is therefore asserted, not independently verified.} The
